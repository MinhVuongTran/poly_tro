        ...
        <div class="main-header">
            ...
            <div class="action">
                ...
                <div class="user-info"
                    ...
                    <ul class="user-action_list">
                        ...
                        <li class="user-action_item"><a
                                href="http://localhost/poly_tro/site/account"
                                class="user-action_item-link">Quản
                                lý tin đăng</a>
                        </li>
                        <?php endif ?>
                        <li class="user-action_item"><a
                                href="http://localhost/poly_tro/site/account/profile"
                        ...
                        <li class="user-action_item"><a
                                href="http://localhost/poly_tro/site/auth/logout"
                                class="user-action_item-link">Đăng
                                xuất</a>
                        </li>
                    </ul>
                </div>
                ...
                <a href="http://localhost/poly_tro/site/account/postNew"
                    class="action-btn postNew">Đăng tin
                    mới</a>
                <?php endif ?>
                <?php else : ?>
                <a href="http://localhost/poly_tro/site/account?signIn"
                    class="action-btn signIn">Đăng nhập</a>
                <a href="http://localhost/poly_tro/site/account?signUp"
                    class="action-btn signUp">Đăng ký</a>
                <a href="http://localhost/poly_tro/site/account/postNew"
                    class="action-btn postNew">Đăng tin
                    mới</a>
                <?php endif ?>
