        ...
        <nav class="account-navbar">
            ...
            <ul class="account-navbar_list">
                <li class="account-navbar_item">
                    <a href="http://localhost/poly_tro" class="account-navbar_item--link">Trang chủ</a>
                </li>
                <li class="account-navbar_item">
                    <a href="" class="account-navbar_item--link">Phòng trọ</a>
                </li>
                <li class="account-navbar_item">
                    <a href="" class="account-navbar_item--link">Nhà cho thuê</a>
                </li>
                <li class="account-navbar_item">
                    <a href="" class="account-navbar_item--link">Căn hộ</a>
                </li>
                <li class="account-navbar_item">
                    <a href="" class="account-navbar_item--link">Mặt bằng</a>
                </li>
                <li class="account-navbar_item">
                    <a href="" class="account-navbar_item--link">Ở ghép</a>
                </li>
            </ul>
        </nav>
                ...
                <ul class="account-sidebar_list">
                    ...
                    <li class="account-sidebar_item">
                        <a href="" class="account-sidebar_item--link">
                            ...
                            <span class="account-sidebar_item--title">Lịch sử thuê phòng</span>
                        </a>
                    </li>
                    <li class="account-sidebar_item">
                        <a href="" class="account-sidebar_item--link">
                            <i class="fa-regular fa-message"></i>
                            <span class="account-sidebar_item--title">Liên hệ</span>
                        </a>
                    </li>
                    <li class="account-sidebar_item">
