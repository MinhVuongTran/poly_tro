      ...
      <footer class="footer">
        <div class="footer-description">
            ...
            <div class="footer-statistical">
                <div class="statistical-item">
                    <span class="footer-title">116.998+</span>
                    <span>Thành viên</span>
                </div>
                <div class="statistical-item">
                    <span class="footer-title">103.348+</span>
                    <span>Tin đăng</span>
                </div>
                <div class="statistical-item">
                    <span class="footer-title">300.000+</span>
                    <span>Lượt truy cập/tháng</span>
                </div>
                <div class="statistical-item">
                    <span class="footer-title">2.500.000+</span>
                    <span>Lượt xem/tháng</span>
                </div>
            </div>
            <p class="footer-title">Chi phí thấp, hiệu quả cao</p>
            <div class="star">
        ...
        <div class="footer-information">
            <div class="footer-information_inner">
                ...
                <div class="about-us">
                    <p class="footer-title">Về POLYTRO.COM</p>
                    <div class="footer-content">
                        <a href="" class="footer-content_item">Trang chủ</a>
                        <a href="" class="footer-content_item">Giới thiệu</a>
                        <a href="" class="footer-content_item">Liên hệ</a>
                    </div>
                </div>
                <div class="support">
                    <p class="footer-title">Hỗ trợ khách hàng</p>
                    <div class="footer-content">
                        <a href="" class="footer-content_item">Hướng dẫn đăng tin</a>
                        <a href="" class="footer-content_item">Quy định đăng tin</a>
                        <a href="" class="footer-content_item">Giải quyết khiếu nại</a>
                    </div>
                </div>
                <div class="contact">
        ...
        <div class="footer-company">
            <p class="footer-title">Copyright © 2010 - 2022 Polytro.com</p>
            <p>Email: fpolytro@gmail.com</p>
            <p class="address">Địa chỉ 1: Tòa nhà FPT Polytechnic, đường Trịnh Văn Bô, Phương Canh, Nam Từ Liêm, Hà Nội</p>
            <p class="address">Địa chỉ 2: 271 Lê Thánh Tông, phường Máy Chai, quận Ngô Quyền, Thành phố Hải Phòng, Hải Phòng</p>
