...
<div class="profile-content">
    ...
    <form
        action="http://localhost/poly_tro/site/account/saveProfile"
        ...
        <div class="form-group2">
            <label for="" class="form-label">Mật
                khẩu</label>
            <a href="http://localhost/poly_tro/site/account/changePassword"
                style="font-size: 1.6rem; color: var(--secondaryColor)">Đổi
                mật khẩu</a>
        </div>
        <?php if ($user['role'] == 0) : ?>
        <div class="form-group2">
            <label for="" class="form-label"></label>
            <a href="http://localhost/poly_tro/site/account/permission"
                style="font-size: 1.6rem; color: var(--secondaryColor)">Đăng
        ...
        <div class="form-group2" style="align-items: start">
            <label for="" class="form-label">Ảnh đại
                diện</label>
            <div>
                <img src="http://localhost/poly_tro<?= $user['image'] ?>"
