   ...
   <table cellspacing="0">
      ...
      <tbody>
         ...
         <tr>
            <td><?= $new['id'] ?></td>
            <td>
                <a href="" class="table-short_title" style="color: var(--secondaryColor)"><?= $new['title'] ?></a>
                <p class="table-short_title"><b>Địa chỉ:</b> <?= $new['address'] ?></p>
           </td>
            ...
            <td><?= $new['status'] == 0 ? "Đang duyệt" : "Đã duyệt" ?></td>
         </tr>
         <?php endforeach ?>
      </tbody>
   </table>
