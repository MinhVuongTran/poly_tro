    ...
    <div class="post-new_content">
        ...
        <form action="http://localhost/poly_tro/site/new/savePostNew" class="post-new_form" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control form-control_normal" name="address">
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control form-control_normal" name="title">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="input-group input-normal">
                    <input type="text" class="form-control form-control_normal" style="border-top-right-radius: 0px; border-bottom-right-radius: 0px;" name="price">
            ...
            <div class="form-group">
                ...
                <div class="input-group input-normal">
                    <input name="area" type="number" class="form-control form-control_normal" style="border-top-right-radius: 0px; border-bottom-right-radius: 0px;">
                    <div class="input-group_append">
            ...
            <div class="form-group">
                ...
                <div class="input-group input-normal">
                    <input name="number_people" type="number" class="form-control form-control_normal " style="border-top-right-radius: 0px; border-bottom-right-radius: 0px;">
                    <div class="input-group_append">
