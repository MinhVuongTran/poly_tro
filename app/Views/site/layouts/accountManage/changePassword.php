...
<div class="">
    ...
    <form action="http://localhost/poly_tro/site/account/saveChangePassword" class="profile-form" method="POST" enctype="multipart/form-data">
        <div class="form-group2">
            <label for="" class="form-label">Mật khẩu
                cũ</label>
            <input type="text" class="form-control form-control_normal" name="oldPassword">
        </div>
        <div class="form-group2">
            <label for="" class="form-label">Mật khẩu
                mới</label>
            <input type="text" class="form-control form-control_normal" name="newPassword">
        </div>
        <div class="form-group2">
            <label for="" class="form-label">Nhập lại mật
                khẩu mới</label>
            <input type="text" class="form-control form-control_normal" name="reNewPassword">
        </div>
